...
interface LogoSQL
{
	...
	public const SQL_AJOUTER_LOGO = "INSERT INTO logo (nom, auteur, description, prix, publication, image) VALUE (:nom, :auteur, :description, :prix, NOW(), :image)";
	public const SQL_MODIFIER_LOGO = "UPDATE logo SET nom = :nom, auteur = :auteur, description = :description, prix = :prix where id = :id";
	public const SQL_LIRE_LOGO = "SELECT nom, auteur, description, prix, image, id FROM logo WHERE id = :id";
